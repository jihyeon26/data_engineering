...
download = BashOperator(
    task_id = 'download',
    bash_command = 'curl -o /home/project/airflow/dags/web-server-access-log.txt https://cf-courses-data.s3.us.cloud-object-storage.appdomain.cloud/IBM-DB0250EN-SkillsNetwork/labs/Apache%20Airflow/Build%20a%20DAG%20using%20Airflow/web-server-access-log.txt',
    dag=dag,
)
